...
function startCronJobs() {
  ...
  console.log('[cron] Jobs scheduled: iCal sync (every 5 min) · OTP cleanup (daily 03:00 UTC) · Stale PENDING cleanup (every 30 min) · Check-in reminders (daily 13:00 UTC) · Survey push (daily 15:00 UTC)');
}
