...
function startCronJobs() {
  ...
  // ── AI Content Agent — Monday 07:00 MST (14:00 UTC) ─────────────────────────
  ...
  console.log(`[cron] Jobs scheduled: iCal sync (hourly) · OTP cleanup (03:00) · Auto-complete past bookings (02:00) · Stale PENDING (30min) · Check-in today admin (08:00) · Daily briefing (10:00 UTC/07:00 BRT) · Task deadline (09:00) · Task overdue (10:00) · Inspection overdue (11:00) · Check-in welcome WA (11:00) · D-7 admin+guest (12:00) · Check-in guest reminder (13:00) · Survey push guest (15:00) · Alert push (30min) · Survey score admin (2h) · Media retention (monthly 04:00, ${RETENTION_MONTHS}mo) · Content agent + RDI blog (Mon 14:00 UTC/07:00 MST) · SRI→RDS sync (04:00 BRT) · NPS reminder (11:00 BRT)`);
}
