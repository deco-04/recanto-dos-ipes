        ...
        <tr><td align="center">
          <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
            ...
            <tr><td style="background:#261C15;padding:32px;text-align:center;">
              <img src="https://sitiorecantodosipes.com/brand/sri-logo-email.png" width="90" height="63" alt="Sítio Recanto dos Ipês" style="display:block;margin:0 auto 16px;border:0;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#F7F7F2;padding:40px 20px;">
        <tr><td align="center">
          <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
            ...
            <!-- Header -->
            <tr><td style="background:#261C15;padding:32px;text-align:center;">
              <img src="https://app.recantosdaserra.com/brand/rds-mark-white.svg" width="48" height="48" alt="Recantos da Serra" style="display:block;margin:0 auto 12px;border:0;">
              <p style="margin:0;color:#C5D86D;font-size:22px;font-weight:700;letter-spacing:-0.3px;">
                Recantos da Serra
              </p>
              <p style="margin:6px 0 0;color:rgba(255,255,255,0.65);font-size:13px;">
