...
async function sendInboxEmail({ to, fromName, subject, body, signature }) {
  ...
  const htmlBody = fullText.replace(/\n/g, '<br>');
...
module.exports = { sendOtpEmail, sendBookingConfirmation, sendStaffInvite, sendAdminNotification, sendGuestInvite, sendPasswordResetEmail, sendCheckoutProblemaAlert, sendInboxEmail };
