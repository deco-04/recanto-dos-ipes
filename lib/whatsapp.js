...
async function seedTemplates() {
  const defaults = [
    ...
    {
      name:         'lembrete_lista_hospedes_urgente',
      description:  'Lembrete D-3 escalado quando hóspede não respondeu ao primeiro reminder',
      triggerEvent: 'guest_list_reminder_urgent',
      variables:    [
        { index: 1, key: 'nome',        label: 'Primeiro nome do hóspede' },
        { index: 2, key: 'data_checkin', label: 'Data de check-in (DD/MM/YYYY)' },
      ],
    },
    {
